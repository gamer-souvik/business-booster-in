        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">NLP & Conversational AI</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">SEO Optimization</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Content Marketing</a></li>
              <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Social Media Strategy</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Stay up to date with our latest insights and news.</p>
            <form className="space-y-2">
              <div className="flex">
                <input
                  type="email"
                  placeholder="Your email"
                  className="w-full px-4 py-2 rounded-l-md bg-gray-800 text-white border-gray-700 focus:outline-none focus:ring-1 focus:ring-white"
                />
                <button
                  type="submit"
